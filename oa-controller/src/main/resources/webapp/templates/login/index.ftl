                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>翼龙贷</strong> 考勤统计平台</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="/kq/login" method="post" class="login-form">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-username">用户名</label>
			                        	  <input type="text" name="userName"  placeholder="LoginName..." class="form-username form-control" id="form-username" value="${(data.userName)!""}">
			                        ...
			                        <button type="submit" class="btn">进 入</button>
			                    </form>
		                    </div>
                        </div>
                    </div>
